...
docker run --rm --name mondial-api-tester --network=mondial -v mondial-api-maven-repository:/root/.m2 -v "$(pwd)":/usr/src/mymaven -w /usr/src/mymaven maven:3-jdk-11 mvn test -Djersey.test.host=api-server
